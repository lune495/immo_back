...
class Outil extends Model
{
    ...
    public static $queries = array(
        "proprietaires"              => " id,code,nom,prenom,telephone,agence_id,agence{id,nom_agence},biens{id,code,adresse,description}",
        "locataires"                 => " id,code,nom,prenom,telephone,bien_immo_id,bien_immo{id,code,description,loyer,bien{code,adresse,description,proprietaire_id,proprietaire{id,code,nom,prenom,telephone,agence_id,agence{id,nom_agence}}}}",
        "users"                      => " id,name,email,role{id,nom}",
        "bien_immos"                 => " id,code,adresse,description,loyer,locataire{id,code,nom,prenom,telephone,bien{id,code,proprietaire{nom,prenom}}}",
        "biens"                      => " id,code,adresse,description,proprietaire_id,proprietaire{id,code,nom,prenom,telephone,agence_id,agence{id,nom_agence}},type_bien_immo{id,nom}",
