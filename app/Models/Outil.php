...
class Outil extends Model
{
    ...
    public static $queries = array(
        ...
        "bien_immos"                 => " id,code,adresse,description,montant,proprietaire_id,proprietaire{id,code,nom,prenom,telephone,agence_id,agence{id,nom_agence},type_bien_immo{id,nom}}",
