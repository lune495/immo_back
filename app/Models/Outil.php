...
class Outil extends Model
{
    ...
    public static $queries = array(
        ...
        "unite"                      =>  " id,numero,dispo,nature_localpcors{id nom},locataires{nom,prenom,solde,resilier},type_localisation,etage,bien_immo{id,code,nom_immeuble,proprietaire{id,code,cgf,nom,prenom}},superficie_en_m2,annee_achevement,nombre_piece_principale,nombre_salle_de_bain,balcon",
        "taxes"                      =>  " id,nom,value",
        "ventes"                     =>  " id,numero,vente_produits{id,vente{id,numero},produit{id,nom}}",
        "produits"                   =>  " id,nom,prix,qte,montant_total",
