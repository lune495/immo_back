...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                \App\GraphQL\Query\ProprioBienImmoQuery::class,
                \App\GraphQL\Query\ProprioBienImmoPaginatedQuery::class,
    ...
    'types' => [
        ...
        \App\GraphQL\Type\ProprioBienImmoType::class,
        \App\GraphQL\Type\ProprioBienImmoPaginatedType::class,
