    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                \App\GraphQL\Query\CompteLocatairePaginatedQuery::class,
                \App\GraphQL\Query\UniteQuery::class,
                \App\GraphQL\Query\DepenseProprioQuery::class,
                \App\GraphQL\Query\AssujetissementQuery::class,
                ...
                \App\GraphQL\Query\LocataireTaxeQuery::class,
                \App\GraphQL\Query\JournalQuery::class,
                \App\GraphQL\Query\JournalProprioQuery::class,
                \App\GraphQL\Query\DetailJournalQuery::class,
                \App\GraphQL\Query\DetailJournalPaginatedQuery::class,
                ...
                \App\GraphQL\Query\JournalPaginatedQuery::class,
            ],
            'mutation' => [
            ...
            'types' => [
                ...
                \App\GraphQL\Type\NatureLocalType::class,
                \App\GraphQL\Type\AssujetissementType::class,
                \App\GraphQL\Type\DashboardType::class,
                \App\GraphQL\Type\TaxeType::class,
                \App\GraphQL\Type\DepenseProprioType::class,
                \App\GraphQL\Type\JournalType::class,
                \App\GraphQL\Type\UniteType::class,
                \App\GraphQL\Type\JournalProprioType::class,
                \App\GraphQL\Type\UnitePaginatedType::class,
                \App\GraphQL\Type\JournalPaginatedType::class,
                \App\GraphQL\Type\DepenseProprioType::class,
                \App\GraphQL\Type\DetailJournalPaginatedType::class,
                \App\GraphQL\Type\DetailJournalType::class,
                ...
                \App\GraphQL\Type\LocataireTaxeType::class,
